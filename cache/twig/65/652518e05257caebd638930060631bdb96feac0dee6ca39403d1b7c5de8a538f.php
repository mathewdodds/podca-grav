...
class __TwigTemplate_82d13223e2ef66d970eb3f8e12f8bf6f1d696c9df490f2124d511750033ef4cc extends \Twig\Template
{
    ...
    public function block_export_button($context, array $blocks = [])
    {
        ...
        // line 12
        echo "            ";
        $this->loadTemplate([0 => (("flex-objects/types/" . ($context["target"] ?? null)) . "/buttons/export-csv.html.twig"), 1 => "flex-objects/types/default/buttons/export-csv.html.twig"], "flex-objects/types/default/titlebar/list.html.twig", 12)->display($context);
        // line 13
        echo "        ";
    ...
    <div class=\"button-bar\">
        ...
        {% if can_export %}
        {% block export_button %}
            {% include ['flex-objects/types/' ~ target ~ '/buttons/export-csv.html.twig', 'flex-objects/types/default/buttons/export-csv.html.twig'] %}
...
{% endblock %}
", "flex-objects/types/default/titlebar/list.html.twig", "F:\\laragon\\www\\podca\\user\\plugins\\flex-objects\\admin\\templates\\flex-objects\\types\\default\\titlebar\\list.html.twig");
    }
}
